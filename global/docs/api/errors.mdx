...
| `exceeded_current_quota_error` | You exceeded your current token quota... | Token quota exceeded. Check your account balance. |
| `rate_limit_reached_error` | ...request reached organization max concurrency... | Concurrency limit reached. Wait and retry. |
| `rate_limit_reached_error` | ...request reached organization max RPM... | RPM rate limit reached. Wait and retry. |
| `rate_limit_reached_error` | ...request reached organization TPM rate limit... | TPM rate limit reached. Wait and retry. |
| `rate_limit_reached_error` | ...request reached organization TPD rate limit... | TPD rate limit reached. Wait and retry. |

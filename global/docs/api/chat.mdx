...
- [Tool Use API](/api/tool-use) - Learn how to use function calling
- [Partial Mode API](/api/partial) - Learn how to use partial mode for guided output
- [Token Estimation API](/api/estimate) - Estimate token usage before making requests

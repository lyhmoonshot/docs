...
- [Create Chat Completion](/docs/api/chat) — Full endpoint parameter reference
- [Tool Use](/docs/api/tool-use) — Enable function calling
- [Partial Mode](/docs/api/partial) — Guide model output format
- [Models Overview](/docs/api/models-overview) — Compare model parameters and capabilities

...
- **Parameter Configuration**: For supported parameters and field descriptions, see [Request Parameter Description](/api/chat#request-body)
...
- Currently, it supports calling official tools through Kimi API, see the document [How to Use Official Tools in Kimi API](/docs/guide/use-official-tools)

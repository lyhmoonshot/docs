...
For token pricing details, refer to [Model Pricing](/docs/pricing/chat-k25).
...
Parameters are listed in [chat](/docs/api/chat). However, behaviour of some parameters may be different in k2.5 models.

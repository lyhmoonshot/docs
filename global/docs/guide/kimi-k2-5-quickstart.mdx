...
For token pricing details, refer to [Model Pricing](/docs/pricing/chat).
...
Parameters are listed in [chat](/api/chat#request-body). However, behaviour of some parameters may be different in k2.5 models.
...
<Info>
  For the full pricing page, including other model families and billing notes, see [Chat Pricing](/docs/pricing/chat).
</Info>

## Learn More

- For the benchmark testing with Kimi K2.5, please refer to this [benchmark best practice](/docs/guide/benchmark-best-practice)
- For the most detailed API usage example of Kimi K2.5, see: [How to Use Kimi Vision Model](/docs/guide/use-kimi-vision-model)
- See [How to Use Kimi K2 in Claude Code, Roo Code, and Cline](/docs/guide/agent-support)
- Learn how to configure and use the [Thinking Model](/docs/guide/use-kimi-k2-thinking-model)

...
- Multitool Collaboration: Bundled with over ten built-in tools (like web search), supporting sophisticated multi-step agent workflows. [Learn more](/docs/guide/use-official-tools).
...
- For further information on Kimi K2 models, see the [Model List](/docs/models)
...
- Kimi K2 is a pure text model. For handling images or other file types, use the [Kimi K2.5](/docs/guide/kimi-k2-5-quickstart) model.
- See [How to use Kimi K2 within Claude Code, Roo Code, Cline](/docs/guide/agent-support).
- See how to use the [Long-Thinking Kimi K2 Model](/docs/guide/use-kimi-k2-thinking-model).
- Web search is one of the powerful tools built into Kimi API. Check here to learn how to use the [Web Search Tool](/docs/guide/use-web-search) and other [Official Tools](/docs/guide/use-official-tools).
- See full [Model Pricing](/docs/pricing/chat-k2), [Recharge & QPS Limit Information](/docs/pricing/limits), and [Web Search Pricing](/docs/pricing/tools).

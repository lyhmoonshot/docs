...
| `web-search` | Real-time information and internet search tool. Web search is currently charged, please see [Web Search Price](/docs/pricing/tools) |
...
As shown in [Is 3214567 a prime number? An example of Tool Calls](/docs/api/tool-use), there are several key points we need to align between the Formula API and the model.

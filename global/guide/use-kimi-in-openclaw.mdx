...
description: "Build an AI agent with OpenClaw and the Kimi K2.5 API. Install and configure your API key for seamless chat on Telegram, Discord, WhatsApp, and more."
---

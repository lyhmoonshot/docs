...
- Newly registered accounts have no balance and need to be topped up before use. It is recommended to recharge \$20 or more to upgrade to tier2 to get a smoother usage experience [Go to recharge](/console/pay)
- Create and copy the API key: [Go to create](/console/api-keys)

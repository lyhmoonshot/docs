...
description: "How recharge tiers map to concurrency, RPM, TPM, and TPD limits on Kimi OpenPlatform, and why rate limits are enforced."
canonical: https://platform.moonshot.ai/docs/pricing/limits
area: "pricing"
capabilities:
  - "rate-limits"
  - "billing"
...
For more details, please refer to the [Rate Limits](https://platform.moonshot.ai/docs/introduction#rate-limits) section.

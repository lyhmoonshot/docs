...
| `rate_limit_reached_error` | ...request reached organization max concurrency: \{Concurrency\}... | 请求触发了账户并发个数的限制，请等待指定时间后重试 |
| `rate_limit_reached_error` | ...request reached organization max RPM: \{RPM\}... | 请求触发了账户 RPM 速率限制，请等待指定时间后重试 |
| `rate_limit_reached_error` | ...request reached organization TPM rate limit... | 请求触发了账户 TPM 速率限制，请等待指定时间后重试 |
| `rate_limit_reached_error` | ...request reached organization TPD rate limit... | 请求触发了账户 TPD 速率限制，请等待指定时间后重试 |

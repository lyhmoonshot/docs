---
title: "Use Kimi K2.5 in OpenClaw"
...
![openclaw](/pics/openclaw/clawbot.jpeg)
...
![recharge](/pics/openclaw/recharge.png)
...
![download](/pics/openclaw/download.png)
...
![success](/pics/openclaw/success.png)

Select \[yes\] and continue with the installation:

![yes](/pics/openclaw/yes.png)

Select the QuickStart option:

![quickstart](/pics/openclaw/quickstart.png)
...
![1](/pics/openclaw/1.png)

![3](/pics/openclaw/3.png)

![models](/pics/openclaw/models.png)

![default\_models](/pics/openclaw/default_models.png)

Then you will see the option to select the chat tool. You can select \[Skip for now\] first:

![4](/pics/openclaw/4.png)

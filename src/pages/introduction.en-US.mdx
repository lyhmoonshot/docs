...
You can use our Chat Completions API to send requests. You need to provide an API key and a model name. You can choose to use the default max_tokens parameter or customize the max_tokens parameter. You can refer to the [API documentation](/docs/api-reference#python-usage) for the calling method.

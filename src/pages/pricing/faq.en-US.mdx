...
* The platform support online invoice applications.After the payment for the recharge order is completed, the platform will automatically issue an invoice. You can download the issued invoice in the [Recharge Details](https://platform.moonshot.ai/console/pay-detail) order list. If you have reserved an email address in the payment process or invoice information management, the platform will send the invoice to your email after it has been successfully issued.
...
* The enterprise-level API product has been released. For pricing and entitlements, please contact sales@kimi.com via email.
* [Kimi Assistant](https://www.kimi.com/) now offers Kimi Business membership benefits for enterprises. For more information, please contact sales@kimi.com.
...
Through the Kimi Campus Partnership, institutions can more effectively explore how AI empowers education—enabling innovation at scale. For more information, please contact sales@kimi.com.
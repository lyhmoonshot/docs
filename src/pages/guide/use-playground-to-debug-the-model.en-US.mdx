...
![prompt](/pics/playground/prompt-en.png)
...
![mcp](/pics/playground/add-mcp-server-en.png)
...
<div style={{ maxWidth: '100%', margin: '20px 0' }}>
  <video controls style={{ width: '100%', height: 'auto' }}>
    <source src="/pics/playground/upload-en.mp4" type="video/mp4" />

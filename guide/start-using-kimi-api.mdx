...
description: "The Kimi API allows you to interact with the Kimi large language model."
---
...
<Steps>
    ...
    <Step>
    An API Key. You need to [create an API Key](https://platform.moonshot.ai/console/api-keys) from the Kimi Open Platform and pass it to the `OpenAi Client` so that we can correctly identify your identity;
    </Step>
</Steps>
...
Due to the uncertainty of the Kimi large language model, the actual response may not be exactly the same as the above content.
</Note>

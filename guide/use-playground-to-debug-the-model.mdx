...
The [Playground development workbench](https://platform.moonshot.ai/playground) is a powerful platform for model debugging and testing, providing an intuitive interface for interacting with and testing AI models. Through this workbench, you can:
...
- **Parameter Configuration**: For supported parameters and field descriptions, see [Tool Use API](/docs/api/tool-use)
...
![prompt](/public/docs/guide/playground/prompt-en.png)
...
- Currently, it supports calling official tools through Kimi API, see the document [Tool Use API](/docs/api/tool-use)
...
![mcp](/public/docs/guide/playground/add-mcp-server-en.png)
...
![date](/public/docs/guide/playground/showcase-en.png)

![date](/public/docs/guide/playground/today-news-en.png)

### Show Case 2: Spreadsheet Analysis Tool

- Tool Selection: Excel analysis tool

![excel](/public/docs/guide/playground/excel-en.png)

## Model Comparison
- Create new conversations through the add conversation feature, supporting up to 3 models running simultaneously

![Model Comparison](/public/docs/guide/playground/model-compare-en.png)
...
<div style={{ maxWidth: '100%', margin: '20px 0' }}>
  ...
  >
    <source src="/public/docs/guide/playground/upload-en.mp4" type="video/mp4" />
